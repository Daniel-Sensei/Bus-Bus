  ...
  export class Tab2Page implements OnInit {
    ...
    // Variabile per memorizzare il raggio selezionato attualmente
  selectedRadius: number = 1000; // 1km di default
    ...
    initializeMap() {
      ...
      this.map.once('zoomend', () => {
       ...
       // Modifica il metodo onAdd per aggiungere una classe CSS al bottone del raggio selezionato
